...
//########## OPERADORES LOGICOS  y esctructuras condicionales(INVERSA, INCREMENTO, )
// AND &
var bool = true;
var numeric = 5;
...
// dos == es para comparar contenido
// tres === es comparar contenido y tipo de datos
console.log(count);
// OR || con if
var age = 31;
if(age === 31 || numeric == "5"){
    console.log("una o dos varaibles aceptadas")
}
else{
    console.slog("ninguna variable aceptada")
}
// for
...
form_register.addEventListener("submit", name_event =>{
    ...
    if(nombres.value.length <=2 || apellidos.value.length <3){
        info += "nombres y apellidos debe ser mayor o igual a 3 caracteres";
